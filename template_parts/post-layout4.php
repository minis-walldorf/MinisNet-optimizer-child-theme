<?php
/*
  * Purpose: Displaying Post list on front page
  * Modification: adding stylesheet which changes the style of sticky posts. Adding it here instead of with a snippet
  *     prevents the style from changing in single post view
  * Author: Kilian Speder
  * Creation Date: 03.05.2023
  * Modification Date: 03.05.2023
  *
  */
...
<!-- Add custom style sheets which changes sticky post style -->
<?php wp_enqueue_style( 'styles/sticky-post-on-front-page', get_stylesheet_uri() ); ?>
